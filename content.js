...
function isUnityYAML(textContent) {
  ...
  const hasUnityFields =
    textContent.includes("GameObject") ||
    textContent.includes("MonoBehaviour") ||
    textContent.includes("m_ObjectHideFlags");
...
function processCodeBlocks() {
  const codeBlocks = document.querySelectorAll(
    "table.diff-table td.blob-code-inner"
  );
